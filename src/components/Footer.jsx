        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex min-[576px]:gap-6 gap-4">
              ...
              <Link to="/terms-of-service" className="text-gray-500 text-sm hover:text-amber-500 transition-colors">Terms of Service</Link>
              <Link to="/sitemap" className="text-gray-500 text-sm hover:text-amber-500 transition-colors">Sitemap</Link>
            </div>
          </div>
        </div>
      </div>
